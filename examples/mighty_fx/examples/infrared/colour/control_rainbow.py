...
"""
Play a rainbow effect on MightyFX's RGB outputs that is controllable by the
directional buttons on a Pimoroni Aye Arr Remote. One effect drives every output,
so the whole board cycles together.
