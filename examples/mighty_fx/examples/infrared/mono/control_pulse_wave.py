...
"""
Play a wave of pulses on MightyFX's outputs that is controllable
...
STARTING_LENGTH = 7.0               # The length of the wave before positions repeat. Usually the number of outputs (7)
