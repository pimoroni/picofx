...
# The flash split: firmware, a read-only ROMFS for the fonts, and the filesystem taking what
# is left. The port reads the last two from here, so mpconfigboard.h does not set them.
...
if(NOT DEFINED MICROPY_HW_FLASH_STORAGE_BYTES)
    math(EXPR MICROPY_HW_FLASH_STORAGE_BYTES
         "${FLASH_SIZE_BYTES} - ${FIRMWARE_SIZE_BYTES} - ${MICROPY_HW_ROMFS_BYTES}")
endif()
